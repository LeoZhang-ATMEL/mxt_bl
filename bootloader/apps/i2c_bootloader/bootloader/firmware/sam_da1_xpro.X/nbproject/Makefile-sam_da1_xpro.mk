...
Device=ATSAMDA1J16B
ProjectDir="D:\Workspace\AI\Customer\Tianma\TPBL\tianma_info4_bootloader\bootloader\apps\i2c_bootloader\bootloader\firmware\sam_da1_xpro.X"
...
${OBJECTDIR}/_ext/123868735/bootloader.o: ../src/config/sam_da1_xpro/bootloader/bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/123868735/bootloader.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -Os -DBOARD_SAMDA1_XPRO -I"../src" -I"../src/config/sam_da1_xpro" -I"../src/packs/ATSAMDA1J16B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -I"../src/arm" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/123868735/bootloader.o.d" -o ${OBJECTDIR}/_ext/123868735/bootloader.o ../src/config/sam_da1_xpro/bootloader/bootloader.c    -DXPRJ_sam_da1_xpro=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp=${DFP_DIR} ${PACK_COMMON_OPTIONS} 
...
${OBJECTDIR}/_ext/123868735/bootloader.o: ../src/config/sam_da1_xpro/bootloader/bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/123868735/bootloader.o.d 
	@${RM} ${OBJECTDIR}/_ext/123868735/bootloader.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/123868735/bootloader.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -Os -DBOARD_SAMDA1_XPRO -I"../src" -I"../src/config/sam_da1_xpro" -I"../src/packs/ATSAMDA1J16B_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -I"../src/arm" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/123868735/bootloader.o.d" -o ${OBJECTDIR}/_ext/123868735/bootloader.o ../src/config/sam_da1_xpro/bootloader/bootloader.c    -DXPRJ_sam_da1_xpro=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp=${DFP_DIR} ${PACK_COMMON_OPTIONS} 
